describe("grails.angularjs.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('grails.angularjs.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/grails/angularjs/index/index.html', '');
    }));
